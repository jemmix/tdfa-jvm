...
- [ ] Clear all pending parity tests — 10 remaining (was 41; 31 cleared: POSIX classes, escape rejection, byte[] overloads, split, DISABLE_UNICODE_GROUPS, matches() anchored groups). See `docs/PARITY-PLAN.md`.
