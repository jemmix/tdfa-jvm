...
class RegexTest {
    ...
    @Test void perlLeftmostFirst() {
        ...
        MatchResult m1 = perl.match("ab", 0);
        ...
        MatchResult m2 = perl.match("ab", 0);
        CompiledRegex perl2 = CompiledRegex.compile("(ab|a)");
        MatchResult m3 = perl2.match("ab", 0);
        ...
        CompiledRegex perl3 = CompiledRegex.compile("(a|aa)");
        MatchResult m4 = perl3.match("aaa", 0);
