...
final class PatternCompiler {
    ...
    private static final int VALID_FLAGS = Pattern.CASE_INSENSITIVE
            | Pattern.DOTALL
            | Pattern.MULTILINE
    ...
    static Pattern compile(
        ...
        try {
            ...
            try {
                ...
                Pattern p = (Pattern)
                        ShellEmitter.emit(new ShellEmitter.Spec(regex, flags, ps, eng, wholeEng, owner, provider));
